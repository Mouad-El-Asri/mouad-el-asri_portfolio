...
const Slider: React.FC = () => {
    return (
        <main className="w-full h-full -z-10 overflow-hidden">
            ...
            <div className="h-full flex flex-col gap-6 justify-center items-center absolute inset-0 text-center box-border text-white px-6">
